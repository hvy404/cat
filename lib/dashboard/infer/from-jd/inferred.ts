...
export async function generateJDInferred(
  ...
  const systemPrompt = `The following context is a job description. Your task is to extract details about the job opportunity according to the provided schema. Only include details in your response for which there is relevant information available in the job description provided. You are to infer details from the context but you may not make any details up. Your answer must be in JSON format.`;
