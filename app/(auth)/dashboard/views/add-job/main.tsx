...
import AddJobBreadcrumb from "@/app/(auth)/dashboard/views/add-job/breadcrumb";
...
import AddJDStepThree from "@/app/(auth)/dashboard/views/add-job/steps/step-3";
import SidePanelStep2 from "@/app/(auth)/dashboard/views/add-job/mods/panel-step-2";
