...
import Step2SubPanelTitle from "@/app/(auth)/dashboard/views/add-job/mods/panel-step-2-title";
import Step2SubPanelLocation from "@/app/(auth)/dashboard/views/add-job/mods/panel-step-2-location";
import Step2SubPanelClearance from "@/app/(auth)/dashboard/views/add-job/mods/panel-step-2-clearance";
import Step2SubPanelSalary from "@/app/(auth)/dashboard/views/add-job/mods/panel-step-2-salary";
import Step2SubPanelPrivateMode from "@/app/(auth)/dashboard/views/add-job/mods/panel-step-2-private";
import Step2SubPanelDefault from "@/app/(auth)/dashboard/views/add-job/mods/panel-step-2-default";
import Step2SubPanelDisplaySalary from "@/app/(auth)/dashboard/views/add-job/mods/panel-step-2-show-salary";
