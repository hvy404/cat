...
/**
 * Component for selecting and applying different node types in the editor.
 * Used in the bubble menu.
 *
 * @component
 * @param {NodeSelectorProps} props - The component props.
 * @param {Editor} props.editor - The editor instance.
 * @param {boolean} props.isOpen - Flag indicating whether the node selector is open.
 * @param {Function} props.setIsOpen - Function to toggle the open state of the node selector.
 * @returns {JSX.Element} The rendered NodeSelector component.
 */
