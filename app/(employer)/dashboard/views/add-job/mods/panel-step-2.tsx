...
import Step2SubPanelClearance from "@/app/(employer)/dashboard/views/add-job/mods/panel-step-2-clearance";
import Step2SubPanelSalary from "@/app/(employer)/dashboard/views/add-job/mods/panel-step-2-salary";
import Step2SubPanelPrivateMode from "@/app/(employer)/dashboard/views/add-job/mods/panel-step-2-private";
import Step2SubPanelDefault from "@/app/(employer)/dashboard/views/add-job/mods/panel-step-2-default";
import Step2SubPanelDisplaySalary from "@/app/(employer)/dashboard/views/add-job/mods/panel-step-2-show-salary";
